...
public interface RegularStatisticsRepository extends JpaRepository<RegularInspection, String> {
    ...
    @Query("SELECT c.regularCheck, COUNT(c) " +
            ...
            "LEFT JOIN c.regularInspection i")
            "WHERE YEAR(i.regularDate) = :year AND MONTH(i.regularDate) = :month " +*/
            /*"GROUP BY c.regularCheck")*/
/*            "AND I.regularInsName = :regularInsName " +
            "GROUP BY c.regularCheck")*/  /*, @Param("regularinsname") String regularInsName*/
    List<Object[]>regularCntByCheckAndMonthSortName();
    ...
    @Query("SELECT c.regularCheck, COUNT(c) " +
            ...
            "AND I.regularInsName = :regularInsName " +
            "GROUP BY c.regularCheck")
    List<Object[]>regularCntByCheckAndMonthSortName( @Param("regularinsname") String regularInsName);*/
